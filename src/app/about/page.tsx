        ...
        <div className="grid md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-xl">
                I'm a passionate developer and designer focused on creating beautiful, functional
                digital experiences.
              </p>

              <p>
                With expertise in both frontend development and design, I bridge the gap between
                aesthetics and functionality, creating websites and applications that not only look
                great but also deliver exceptional user experiences.
              </p>

              <p>
                My approach combines thoughtful design principles with clean, efficient code to
                build solutions that solve real problems for users and businesses alike.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-3xl mx-auto mb-16">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p>
            ...
            invaluable, teaching me how to approach projects holistically, considering both
            technical constraints and user needs.
          </p>

          <p>
            Over the years, I've worked with various organizations, from startups to established
            companies, helping them build digital products that align with their business goals
            while delighting their users. Each project has taught me something new, contributing to
            my growth as a developer and designer.
          </p>

          <h3>Philosophy & Approach</h3>
          <p>
            I believe that the best digital experiences are those that feel invisible – they work so
            seamlessly that users don't even notice the technology behind them. This philosophy
            guides my approach to both development and design.
          </p>
          ...
          <p>
            ...
            passionate about responsive design, ensuring that websites work flawlessly across all
            devices.
          </p>

          <h3>Beyond Work</h3>
          <p>
            When I'm not coding or designing, you might find me exploring new hiking trails,
            experimenting with photography, or contributing to open-source projects. I'm a firm
            believer in continuous learning and regularly attend tech conferences and workshops to
            ...
            <div className="md:flex">
              ...
              <div className="p-6 md:w-2/3">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                  ...
                  user experience and conversion rates. Implemented responsive design, optimized
                  checkout flow, and integrated with payment gateways.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="inline-block px-2 py-1 text-xs rounded-full bg-neutral-100 dark:bg-neutral-700">
                    React
                  </span>
                  <span className="inline-block px-2 py-1 text-xs rounded-full bg-neutral-100 dark:bg-neutral-700">
                    Node.js
                ...
                <a href="#" className="text-neutral-900 dark:text-white hover:underline">
                  View Details →
                </a>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-lg overflow-hidden shadow-sm">
            <div className="md:flex">
              ...
              <div className="p-6 md:w-2/3">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                  Developed a secure healthcare management application that allows patients to book
                  appointments, access medical records, and communicate with healthcare providers.
                  Implemented strict security measures to ensure data protection.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="inline-block px-2 py-1 text-xs rounded-full bg-neutral-100 dark:bg-neutral-700">
                    Next.js
