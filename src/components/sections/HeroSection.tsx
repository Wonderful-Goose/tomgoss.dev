...
export default function HeroSection(/* props: HeroSectionProps */) {
  ...
  const animationSequence = skills.reduce(
    (acc, skill) => {
  ...
  return (
    <section className="container mx-auto px-4 py-20 md:py-32 text-center relative">
      ...
      <p className="font-sans text-xl text-accent mt-0 mb-2">specialising in</p>
      ...
      {/* Concise Bio */}
      <p className="font-sans mt-8 text-xl text-textPrimary max-w-2xl mx-auto mb-8">{bio}</p>
